  ...
  return (
    <main>
      <section className="container mx-auto px-4 py-16">
        <div className="mb-12">
          <h1 className="font-serif text-5xl font-bold text-foreground">{category.slug === 'electronics' ? 'Gadgets' : category.name}</h1>
        ...
        <div className="mb-12">
          <GlobalSearch
            products={products}
            placeholder={`Search within ${category.slug === 'electronics' ? 'Gadgets' : category.name}...`}
          />
        </div>
